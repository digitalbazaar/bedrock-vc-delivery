...
describe.skip('exchange w/ OID4VP multiple client profiles', () => {
  ...
  it('should pass with first profile', async () => {
    ...
    const clientBaseUrl = `${exchangeId}/openid/clients/foo`;
  ...
  it('should pass with another profile', async () => {
    // create an exchange with appropriate variables for the step template
    const exchange = {
      // 15 minute expiry in seconds
      ttl: 60 * 15,
  ...
  it('should prevent switching client profiles in an active exchange',
    async () => {
      // create an exchange with appropriate variables for the step template
      const exchange = {
        // 15 minute expiry in seconds
