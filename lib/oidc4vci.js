...
import {oidc4vciCredentialBody} from '../schemas/bedrock-vc-exchanger.js';
...
async function _requestDidProof({res, exchanger}) {
  ...
  // FIXME: generate challenge via verifier API; ideally we can fully use
