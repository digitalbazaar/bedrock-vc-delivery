  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      while(true) {
        ...
        // FIXME: if `step.type` exists then assume it's `jsonata` as this
        // was validated when created; use `step.template` to generate the
        // step to use against the variables in the exchange state
