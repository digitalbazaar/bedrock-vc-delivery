...
export async function verify({
  workflow, verifyPresentationOptions,  verifiablePresentationRequest, presentation,
  allowUnprotectedPresentation = false, expectedChallenge, verifyPresentationResultSchema
} = {}) {
  ...
  const verificationMethod = presentationResult?.results[0]
   ...
   // validate the verify presentation result, if applicable
